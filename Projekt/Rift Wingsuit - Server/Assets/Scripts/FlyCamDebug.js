...
var terrainDetailDistance = 5000;     
...
function Update () {
    ...
    if(canMove == true){
        ...
        lastMouse = Vector3(transform.eulerAngles.x + lastMouse.x , transform.eulerAngles.y, 0);
    }
    ...
    Terrain.activeTerrain.detailObjectDistance = terrainDetailDistance;
